...
$return['recordsTotal'] = $obj->selectfieldwhere("mail", "count(mail.id)", "status = 1 and senderid = $id");
$return['recordsFiltered'] = $obj->selectfieldwhere("mail", "count(mail.id)", "status = 1 and senderid = $id $search ");
$return['draw'] = $_GET['draw'];
