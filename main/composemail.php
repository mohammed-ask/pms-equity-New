        ...
        <div class="col-12">
            <div class="card card-default">
                    ...
                    <div class="card-body">
                        <label class="block text-md" style="margin-bottom: 5px;">
                            ...
                            <!-- <select data-bvalidator="required" class="form-control select2" name="userid" id="userid">
                                ...
                                <?php
                                // $cust = $obj->selectextrawhereupdate("users", "id,name", "status != 99 and name='admin'");
                ...
                <div class="card-footer">
                    <button class="px-4 py-2  text-sm  bg-green  rounded-lg border border-gray" onclick="sendForm('', '', 'insertmail', 'resultid', 'addtax')">Send Mail</button>
