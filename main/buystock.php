                    ...
                    <div class="row mt-3" style="padding-right: 0px;">
                        <div class="col" style="padding-right: 0px;">
                            ...
                            <?php } elseif ($stockdata['Exch'] === 'M') { ?>
                                ...
                                <button style="width: 100%; background-color: #55bc1d; border-color: #55bc1d;" <?php echo $investmentamount > 0 && $commoditymrkt[0]['MarketStatus'] === 'Open'  ? null : 'disabled'; ?> class="btn btn-success w-100 my-3" onclick="<?php echo $investmentamount > 0 && $commoditymrkt[0]['MarketStatus'] === 'Open' ? 'event.preventDefault();sendForm(\'\', \'\', \'insertbuystock\', \'resultid\', \'buystock\')' : ''; ?>">BUY</button>
                            <?php } ?>
                            <div id="resultid"></div>
