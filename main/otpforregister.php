...
<head>
    ...
    <title>OTP Email</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="text-align: center;">
                                    ...
                                    <h1 class="email-title">OTP For Account Verification</h1>
                            ...
                            <tr>
                                <td style="text-align: center;">
                                    <div class="text-author" style=" margin-bottom: 20px;">
                                        ...
                                        <h3 style="margin-bottom: 10px;">Your Six Digit OTP for Account Verification is</h3>
