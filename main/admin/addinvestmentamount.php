...
<div class="row">
    ...
    <label class="col-5 block text-sm" style="margin-bottom: 5px;">
    ...
    <label class="col-7 block text-sm" style="margin-bottom: 5px;">
        <span class="text-gray-700 dark:text-gray-400">Payment Screenshort</span>
        <input name="paymentmethod" type="file" step="any" class="form-control" placeholder="Payment Method" />
    </label></div>
