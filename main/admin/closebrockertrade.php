...
<div class="col-6">
    <label class="block text-sm mb-3" style="margin-bottom: 5px;">
        ...
        <input class="form-control" name="qty" hidden value="<?= $rowtran['qty'] ?>" />
        <input class="form-control" name="userid" hidden value="<?= $rowtran['userid'] ?>" />
        <input class="form-control" name="cprice" data-bvalidator="required" class="form-control" value="<?= $stockdata['LastTradedPrice'] ?>" />
    </label>
