...
<div class="row">
    <label class="col-lg-6 col-lg-6 block text-sm  mb-3" style="margin-bottom: 5px;">
        <span class="text-gray-700 dark:text-gray-400">Stock Name</span>
        <input name="Symbol" data-bvalidator="required" class="form-control" placeholder="Stock Full Name with Expiry & Strike Price" />
    </label>
    <label class="col-lg-6 col-lg-6 block text-sm  mb-3" style="margin-bottom: 5px;">
