        ...
        if (!empty($mrkt)) { ?>
            <div class="col" style="padding-right: 0px;">
                ...
                <?php } elseif ($stockdata['Exch'] === 'M') { ?>
                    <button style="width: 100%; background-color: rgb(213, 9, 9); border-color: rgb(213, 9, 9);" <?php echo $investmentamount > 0 && $commoditymrkt[0]['MarketStatus'] === 'Open' ? null : 'disabled'; ?> class="btn btn-danger w-100 my-3" onclick="<?php echo $investmentamount > 0 && $commoditymrkt[0]['MarketStatus'] === 'Open' ? 'event.preventDefault();sendForm(\'\', \'\', \'insertsellstock\', \'resultid\', \'sellstock\')' : ''; ?>">SELL</button>
                <?php } ?>
                <div id="resultid"></div>
