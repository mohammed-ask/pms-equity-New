      ...
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="mb-4">Enter your email and we'll send you instructions to reset your MPIN</p>

            <form method="post" onsubmit="event.preventDefault();sendForm('', '', 'checkforgetmpin', 'resultid', 'loginform','Login');return 0;" id="loginform">
              <div class="mb-3">
