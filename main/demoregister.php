...
<head>
    ...
    <title>Register - Eagle Eye Trading</title>
        ...
        <div class="flex-1 h-full max-w-4l mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
            <div class="flex flex-col overflow-y-auto md:flex-row">
                <div class="h-32 md:h-auto md:w-1/2">
                    <img aria-hidden="true" class="object-cover w-full h-full dark:hidden" src="main/images/eeye.png" style="height:auto;margin-top:20px" alt="Office" />
                    <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block" src="main/images/eeye.png" style="height:auto" alt="Office" />
                </div>
                <div style="padding-left: 2rem; padding-right: 2rem;" class="items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <form method="post" onsubmit="event.preventDefault();sendForm('', '', 'insertdemoregister', 'resultid', 'loginform','Login');return 0;" id="loginform">
                        <div class="w-full">
                            <h4 class="mb-4 text-l font-semibold text-gray-700 dark:text-gray-200">
                                Register to Eagle Eye Trading
                            </h4>
                            <label class="block text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Email</span>
                                <input name="email" data-bvalidator='required' class="form-control" placeholder="Enter your mail ID" />
                            </label>
                            <label class="block text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Mobile No</span>
                                <input name="mobile" data-bvalidator='required' class="form-control" placeholder="Enter your mobile no" />
                            </label>
                            <label class="block mt-4 mb-2 text-sm" style="position:relative">
                                <span class="text-gray-700 dark:text-gray-400">Password</span>
                                <input name="password" data-bvalidator='required' id="pass" class="form-control" placeholder="********" type="password" />
                                <i id="eye" class="fa fa-eye" style="position: absolute; top:38px; right:10px" aria-hidden="true"></i>
                            </label>
                            <div id="resultid"></div>
                            <!-- You should use a button here, as the anchor is only used for the example  -->
                            <button type="submit" style="background-color: #696cff;" class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                Register
                            </button>

                            <p class="mt-1">
                                <a style="color:#696cff" class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" href="login">
